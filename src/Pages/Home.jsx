...
const TECH_STACK = [];
const SOCIAL_LINKS = [
  { icon: Linkedin, link: "https://www.linkedin.com/in/sinchana-h-04427528a/" },
  { icon: Github, link: "https://github.com/Sinchana587" },
  { icon: Mail, link: "mailto:sinchanasinchu2062004@gmail.com" }
];
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`relative lg:left-12 z-10 w-full opacity-90 transform transition-transform duration-500 ${
                  ...
                  <img 
                    src="/my1.webp" 
                    alt="Profile" 
                    style={{ width: '100%', maxWidth: 600, height: 350, borderRadius: '1.5rem', boxShadow: '0 8px 32px rgba(0,0,0,0.25)', objectFit: 'cover' }} 
                  />
                </div>
