  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || selectedProject.GithubLink || 'https://github.com/EkiZR',
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                {project.Github && project.Github !== 'Private' ? (
                  <a
                    ...
                    className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white font-semibold shadow-md hover:scale-105 transition-transform duration-200"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl bg-gradient-to-r from-gray-500 to-gray-700 text-white font-semibold shadow-md cursor-not-allowed opacity-60"
                    disabled
                  >
                ...
                {techStack.length > 0 ? (
                  <ul className="list-disc pl-6">
                    {techStack.map((tech, idx) => (
                      <li key={idx} className="text-gray-300 text-base mb-1">
                        {tech}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                ...
                <img
                  src={project.Image2 ? (project.Image2.startsWith('/') ? project.Image2 : '/' + project.Image2) : (project.Image ? project.Image : "/twitter1.png")}
                  alt={project.Title}
