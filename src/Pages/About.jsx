    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             A Computer Science student at PES University with a strong passion for software development and innovative technology. I focus on solving real-world problems through programming and building impactful digital solutions. Eager to learn and grow, I'm actively developing my skills in Front-End Development, Machine Learning, Data structures and AI-based projects. I believe in creating meaningful experiences with technology and always strive to deliver the best possible solution in every project I take on.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Empowering ideas through code, driven by curiosity and purpose."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
               <a href="https://drive.google.com/file/d/1bacm6kwELFtKDsXt_-q3M15bv1dsASwi/view?usp=drive_link" className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer">
                <button 
                  data-aos="fade-up"
                  data-aos-duration="800"
